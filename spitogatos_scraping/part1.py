# """https://www.spitogatos.gr/search/results/residential/sale/r100/m2038m2610m2616m3011m6007m6013m384410m/price_nd-30000/floorNumber_ground_floor-nd?ref=refinedSearchSR"""
# Residential sales in Petralona, ​​Moschato, Tavros, Kallithea, Exarchia - Neapoli, Pagrati and Kypseli
import requests
...
class Spitoscraper():
    ...
    params = "ref: homepageMapSearchSR"
    headers = {
    ...
    def run(self):
        res = self.fetch('https://www.spitogatos.gr/search/results/residential/sale/r100/m2038m2610m2616m3011m6007m6013m384410m/price_nd-30000/floorNumber_ground_floor-nd?ref=refinedSearchSR')
